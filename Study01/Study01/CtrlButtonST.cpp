...
BEGIN_MESSAGE_MAP(CCtrlButtonST, CButton)
    //{{AFX_MSG_MAP(CCtrlButtonST)
...
DWORD CCtrlButtonST::SetIcon(int nIconInId, int nIconOutId)
{
	HICON		hIconIn;
	HICON		hIconOut;
...
DWORD CCtrlButtonST::SetIcon(HICON hIconIn, HICON hIconOut)
{
	BOOL		bRetValue;
	ICONINFO	ii;
...
BOOL CCtrlButtonST::SetBtnCursor(int nCursorId)
{
	HINSTANCE hInstResource;
...
void CCtrlButtonST::SetFlat(BOOL bState)
{
	m_bIsFlat = bState;
	Invalidate(false);
} // End of SetFlat
...
BOOL CCtrlButtonST::GetFlat()
{
	return m_bIsFlat;
} // End of GetFlat


void CCtrlButtonST::SetAlign(int nAlign)
{
	switch (nAlign)
	{    
		case ST_ALIGN_HORIZ:
...
int CCtrlButtonST::GetAlign()
{
	return m_nAlign;
} // End of GetAlign


void CCtrlButtonST::DrawBorder(BOOL bEnable)
{
	m_bDrawBorder = bEnable;
} // End of DrawBorder

void CCtrlButtonST::OnMouseMove(UINT nFlags, CPoint point)
{
...
void CCtrlButtonST::OnKillFocus(CWnd * pNewWnd)
{
...
void CCtrlButtonST::OnLButtonDown(UINT nFlags, CPoint point) 
{
...
void CCtrlButtonST::OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized) 
{
...
void CCtrlButtonST::OnEnable(BOOL bEnable) 
{
...
void CCtrlButtonST::OnCancelMode() 
{
...
void CCtrlButtonST::OnCaptureChanged(CWnd *pWnd) 
{
	if (m_bMouseOnButton == TRUE)
	{
		ReleaseCapture();
...
void CCtrlButtonST::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
...
void CCtrlButtonST::DrawTheIcon(CDC* pDC, BOOL bHasTitle, RECT* rpItem, CRect* rpTitle, BOOL bIsPressed, BOOL bIsDisabled)
{
	BYTE		byIndex		= 0;
...
void CCtrlButtonST::PreSubclassWindow() 
{
	UINT nBS;
...
BOOL CCtrlButtonST::PreTranslateMessage(MSG* pMsg) 
{
	InitToolTip();
...
LRESULT CCtrlButtonST::DefWindowProc(UINT message, WPARAM wParam, LPARAM lParam) 
{
...
void CCtrlButtonST::SetFlatFocus(BOOL bDrawFlatFocus, BOOL bRepaint)
{
	m_bDrawFlatFocus = bDrawFlatFocus;
	
	// Repaint the button
	if (bRepaint == TRUE) Invalidate(false);
} // End of SetFlatFocus

BOOL CCtrlButtonST::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message) 
{
...
void CCtrlButtonST::SetTooltipText(LPCTSTR lpszText, BOOL bActivate)
{
...
void CCtrlButtonST::SetTooltipText(int nId, BOOL bActivate)
{
	CString sText;
...
void CCtrlButtonST::ActivateTooltip(BOOL bActivate)
{
...
BOOL CCtrlButtonST::GetDefault()
{
	return m_bIsDefault;
} // End of GetDefault


void CCtrlButtonST::DrawTransparent(BOOL bRepaint)
{
...
void CCtrlButtonST::InitToolTip()
{
...
void CCtrlButtonST::PaintBk(CDC* pDC)
{
...
HBRUSH CCtrlButtonST::CtlColor(CDC* pDC, UINT nCtlColor) 
{
	return (HBRUSH)::GetStockObject(NULL_BRUSH); 
} // End of CtlColor


void CCtrlButtonST::OnSysColorChange() 
{
...
void CCtrlButtonST::SetCheck(int nCheck, BOOL bRepaint)
{
	if (m_bIsCheckBox == TRUE)
	{
...
int CCtrlButtonST::GetCheck()
{
	return m_nCheck;
} // End of GetCheck

void CCtrlButtonST::FreeResources(BOOL bCheckForNULL)
{
...
DWORD CCtrlButtonST::SetBitmaps(HBITMAP hBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut, COLORREF crTransColorOut)
{
	int		nRetValue;
	BITMAP	csBitmapSize;
...
DWORD CCtrlButtonST::SetBitmaps(int nBitmapIn, COLORREF crTransColorIn, int nBitmapOut, COLORREF crTransColorOut)
{
...
void CCtrlButtonST::DrawTheBitmap(CDC* pDC, BOOL bHasTitle, RECT* rItem, CRect *rCaption, BOOL bIsPressed, BOOL bIsDisabled)
{
	HDC			hdcBmpMem	= NULL;
...
HBITMAP CCtrlButtonST::CreateBitmapMask(HBITMAP hSourceBitmap, DWORD dwWidth, DWORD dwHeight, COLORREF crTransColor)
{
	HBITMAP		hMask		= NULL;
	HDC			hdcSrc		= NULL;
	HDC			hdcDest		= NULL;
...
//
void CCtrlButtonST::PrepareImageRect(BOOL bHasTitle, RECT* rpItem, CRect* rpTitle, BOOL bIsPressed, DWORD dwWidth, DWORD dwHeight, CRect* rpImage)
{
	CRect rBtn;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
DWORD CCtrlButtonST::SetDefaultColors(BOOL bRepaint)
{
	///////////////////////////////////////////////////////////////////////////////////////////////
	m_crColors[BTNST_COLOR_BK_IN]	= RGB(0, 0, 0);			//::GetSysColor(COLOR_BTNFACE);
	m_crColors[BTNST_COLOR_FG_IN]	= RGB(255, 255, 255);	//::GetSysColor(COLOR_BTNTEXT);
	m_crColors[BTNST_COLOR_BK_OUT]	= RGB(0, 0, 0);			//::GetSysColor(COLOR_BTNFACE);
	m_crColors[BTNST_COLOR_FG_OUT]	= RGB(255, 255, 255);	//::GetSysColor(COLOR_BTNTEXT);
	///////////////////////////////////////////////////////////////////////////////////////////////
...
//			Invalid color index.
//
DWORD CCtrlButtonST::SetColor(BYTE byColorIndex, COLORREF crColor, BOOL bRepaint)
{
...
//			Invalid color index.
//
DWORD CCtrlButtonST::GetColor(BYTE byColorIndex, COLORREF* crpColor)
{
	if (byColorIndex >= BTNST_MAX_COLORS)	return BTNST_INVALIDINDEX;
...
//			Function executed successfully.
//
DWORD CCtrlButtonST::SetURL(LPCTSTR lpszURL)
{
	if (lpszURL != NULL)
	{
		// Store the URL
...
void CCtrlButtonST::CancelHover()
{
	// If our button is not flat then do nothing
	if (m_bIsFlat == FALSE) return;
...
//			Function executed successfully.
//
DWORD CCtrlButtonST::SetAutoRepeat(BOOL bSet, DWORD dwMilliseconds)
{
	m_bAutoRepeat = bSet;
...
//			Function executed successfully.
//
DWORD CCtrlButtonST::OnDrawBackground(CDC* pDC, LPCRECT pRect)
{
	COLORREF	crColor;
...
//			Function executed successfully.
//
DWORD CCtrlButtonST::OnDrawBorder(CDC* pDC, LPCRECT pRect)
{
	if (m_bIsPressed)
